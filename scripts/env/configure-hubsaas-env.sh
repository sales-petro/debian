...
# Ex.: ./configure-hubsaas-env.sh https://cytoplasm-quicken-asparagus.ngrok-free.dev
...
set_env_var "$FRONTEND_ENV" "VITE_DEFAULT_TENANT_SLUG" "hubsaas"

echo ""
echo "Backend:  PORT=3021, FRONTEND_URL=$PUBLIC_URL"
echo "Frontend: PORT=3020, VITE_API_URL=/v1/, VITE_DEFAULT_TENANT_SLUG=hubsaas"
echo ""
